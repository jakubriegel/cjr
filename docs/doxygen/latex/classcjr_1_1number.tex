...
\hline
\end{DoxyParams}
\hypertarget{classcjr_1_1number_a5f2aeb5b369b048c53e2a0c209a5476e}{\index{cjr\-::number@{cjr\-::number}!times\-Base@{times\-Base}}
\index{times\-Base@{times\-Base}!cjr::number@{cjr\-::number}}
\subsubsection[{times\-Base}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class B $>$ void {\bf cjr\-::number}$<$ B $>$\-::times\-Base (
\begin{DoxyParamCaption}
\item[{unsigned int}]{power = {\ttfamily 1}}
\end{DoxyParamCaption}
)}}\label{classcjr_1_1number_a5f2aeb5b369b048c53e2a0c209a5476e}


Multiplies the number by given power of its base. 

Virtually it is adding 0(or few zeros) at the end of the number 
\begin{DoxyParams}{Parameters}
{\em power} & power of the base \\
\hline
\end{DoxyParams}
